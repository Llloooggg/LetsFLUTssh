...
- **All new code must have tests** — write unit/widget tests for every new feature, refactoring, or bug fix; target ≥80% coverage on new lines (SonarCloud Quality Gate)
...
- **490 tests** — 209 unit + 67 widget + 7 deeplink; covers all core modules and major UI components; mockito mocks for SSH shell (ShellHelper)
...
- **490 tests** — updated for new dialog result types (Save & Connect / Connect), welcome screen (onNewSession)
