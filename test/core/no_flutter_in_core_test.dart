...
/// and must stay free of Flutter UI, platform plugins, Riverpod, and
/// l10n. The ONLY framework dependency allowed is `flutter_rust_bridge`
/// (the Rust bridge runtime that core wraps); everything else in core is
...
void main() {
  test('lib/core imports no Flutter UI / plugins / Riverpod / l10n', () {
