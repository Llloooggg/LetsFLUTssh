...
/// Encode sessions and empty folders into a compact JSON string for QR codes.
///
...
/// Decode sessions and empty folders from a QR payload string.
///
...
class QrImportData {
  ...
  const QrImportData({required this.sessions, required this.emptyFolders});
}
