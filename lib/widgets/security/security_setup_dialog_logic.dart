...
/// plaintext has nothing to gate (toggle is fixed off).
/// Hardware and Keychain let the user pick.
...
/// Keychain/Hardware do not ask; password-gated variants do.
bool wizardNeedsSecretInput({
  ...
  if (selected == WizardTier.hardware && password) return true;
  return false;
}
