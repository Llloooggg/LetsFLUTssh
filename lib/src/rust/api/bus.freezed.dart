...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( BusConnectAuthRef_Password value)?  password,TResult Function( BusConnectAuthRef_Pubkey value)?  pubkey,TResult Function( BusConnectAuthRef_PubkeyCert value)?  pubkeyCert,TResult Function( BusConnectAuthRef_PubkeySk value)?  pubkeySk,TResult Function( BusConnectAuthRef_PubkeySkCert value)?  pubkeySkCert,TResult Function( BusConnectAuthRef_PubkeyPkcs11 value)?  pubkeyPkcs11,TResult Function( BusConnectAuthRef_PubkeyEnclave value)?  pubkeyEnclave,TResult Function( BusConnectAuthRef_PubkeyHello value)?  pubkeyHello,TResult Function( BusConnectAuthRef_PubkeyTpm value)?  pubkeyTpm,TResult Function( BusConnectAuthRef_PubkeyKeystore value)?  pubkeyKeystore,TResult Function( BusConnectAuthRef_Agent value)?  agent,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return pubkeySk(_that);case BusConnectAuthRef_PubkeySkCert() when pubkeySkCert != null:
return pubkeySkCert(_that);case BusConnectAuthRef_PubkeyPkcs11() when pubkeyPkcs11 != null:
return pubkeyPkcs11(_that);case BusConnectAuthRef_PubkeyEnclave() when pubkeyEnclave != null:
return pubkeyEnclave(_that);case BusConnectAuthRef_PubkeyHello() when pubkeyHello != null:
return pubkeyHello(_that);case BusConnectAuthRef_PubkeyTpm() when pubkeyTpm != null:
return pubkeyTpm(_that);case BusConnectAuthRef_PubkeyKeystore() when pubkeyKeystore != null:
return pubkeyKeystore(_that);case BusConnectAuthRef_Agent() when agent != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( BusConnectAuthRef_Password value)  password,required TResult Function( BusConnectAuthRef_Pubkey value)  pubkey,required TResult Function( BusConnectAuthRef_PubkeyCert value)  pubkeyCert,required TResult Function( BusConnectAuthRef_PubkeySk value)  pubkeySk,required TResult Function( BusConnectAuthRef_PubkeySkCert value)  pubkeySkCert,required TResult Function( BusConnectAuthRef_PubkeyPkcs11 value)  pubkeyPkcs11,required TResult Function( BusConnectAuthRef_PubkeyEnclave value)  pubkeyEnclave,required TResult Function( BusConnectAuthRef_PubkeyHello value)  pubkeyHello,required TResult Function( BusConnectAuthRef_PubkeyTpm value)  pubkeyTpm,required TResult Function( BusConnectAuthRef_PubkeyKeystore value)  pubkeyKeystore,required TResult Function( BusConnectAuthRef_Agent value)  agent,}){
final _that = this;
switch (_that) {
...
return pubkeySk(_that);case BusConnectAuthRef_PubkeySkCert():
return pubkeySkCert(_that);case BusConnectAuthRef_PubkeyPkcs11():
return pubkeyPkcs11(_that);case BusConnectAuthRef_PubkeyEnclave():
return pubkeyEnclave(_that);case BusConnectAuthRef_PubkeyHello():
return pubkeyHello(_that);case BusConnectAuthRef_PubkeyTpm():
return pubkeyTpm(_that);case BusConnectAuthRef_PubkeyKeystore():
return pubkeyKeystore(_that);case BusConnectAuthRef_Agent():
return agent(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( BusConnectAuthRef_Password value)?  password,TResult? Function( BusConnectAuthRef_Pubkey value)?  pubkey,TResult? Function( BusConnectAuthRef_PubkeyCert value)?  pubkeyCert,TResult? Function( BusConnectAuthRef_PubkeySk value)?  pubkeySk,TResult? Function( BusConnectAuthRef_PubkeySkCert value)?  pubkeySkCert,TResult? Function( BusConnectAuthRef_PubkeyPkcs11 value)?  pubkeyPkcs11,TResult? Function( BusConnectAuthRef_PubkeyEnclave value)?  pubkeyEnclave,TResult? Function( BusConnectAuthRef_PubkeyHello value)?  pubkeyHello,TResult? Function( BusConnectAuthRef_PubkeyTpm value)?  pubkeyTpm,TResult? Function( BusConnectAuthRef_PubkeyKeystore value)?  pubkeyKeystore,TResult? Function( BusConnectAuthRef_Agent value)?  agent,}){
final _that = this;
switch (_that) {
case BusConnectAuthRef_Password() when password != null:
return password(_that);case BusConnectAuthRef_Pubkey() when pubkey != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String secretId)?  password,TResult Function( String keySecretId,  String? passphraseSecretId)?  pubkey,TResult Function( String keySecretId,  String certSecretId,  String? passphraseSecretId)?  pubkeyCert,TResult Function( String publicOpenssh,  Uint8List credentialId,  String application,  String? pinSecretId)?  pubkeySk,TResult Function( String publicOpenssh,  Uint8List credentialId,  String application,  String certSecretId,  String? pinSecretId)?  pubkeySkCert,TResult Function( String publicOpenssh,  String modulePath,  String tokenSerial,  Uint8List ckaId,  String keyType,  String? pinSecretId)?  pubkeyPkcs11,TResult Function( String publicOpenssh,  Uint8List applicationTag)?  pubkeyEnclave,TResult Function( String publicOpenssh,  String credentialName,  String keyType)?  pubkeyHello,TResult Function( String publicOpenssh,  String provider,  Uint8List? blob,  String? cngKeyName,  String keyType,  String? pinSecretId)?  pubkeyTpm,TResult Function( String publicOpenssh,  String keystoreAlias,  String keyType)?  pubkeyKeystore,TResult Function()?  agent,required TResult orElse(),}) {final _that = this;
switch (_that) {
case BusConnectAuthRef_Password() when password != null:
...
return pubkeySk(_that.publicOpenssh,_that.credentialId,_that.application,_that.pinSecretId);case BusConnectAuthRef_PubkeySkCert() when pubkeySkCert != null:
return pubkeySkCert(_that.publicOpenssh,_that.credentialId,_that.application,_that.certSecretId,_that.pinSecretId);case BusConnectAuthRef_PubkeyPkcs11() when pubkeyPkcs11 != null:
return pubkeyPkcs11(_that.publicOpenssh,_that.modulePath,_that.tokenSerial,_that.ckaId,_that.keyType,_that.pinSecretId);case BusConnectAuthRef_PubkeyEnclave() when pubkeyEnclave != null:
return pubkeyEnclave(_that.publicOpenssh,_that.applicationTag);case BusConnectAuthRef_PubkeyHello() when pubkeyHello != null:
return pubkeyHello(_that.publicOpenssh,_that.credentialName,_that.keyType);case BusConnectAuthRef_PubkeyTpm() when pubkeyTpm != null:
return pubkeyTpm(_that.publicOpenssh,_that.provider,_that.blob,_that.cngKeyName,_that.keyType,_that.pinSecretId);case BusConnectAuthRef_PubkeyKeystore() when pubkeyKeystore != null:
return pubkeyKeystore(_that.publicOpenssh,_that.keystoreAlias,_that.keyType);case BusConnectAuthRef_Agent() when agent != null:
return agent();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String secretId)  password,required TResult Function( String keySecretId,  String? passphraseSecretId)  pubkey,required TResult Function( String keySecretId,  String certSecretId,  String? passphraseSecretId)  pubkeyCert,required TResult Function( String publicOpenssh,  Uint8List credentialId,  String application,  String? pinSecretId)  pubkeySk,required TResult Function( String publicOpenssh,  Uint8List credentialId,  String application,  String certSecretId,  String? pinSecretId)  pubkeySkCert,required TResult Function( String publicOpenssh,  String modulePath,  String tokenSerial,  Uint8List ckaId,  String keyType,  String? pinSecretId)  pubkeyPkcs11,required TResult Function( String publicOpenssh,  Uint8List applicationTag)  pubkeyEnclave,required TResult Function( String publicOpenssh,  String credentialName,  String keyType)  pubkeyHello,required TResult Function( String publicOpenssh,  String provider,  Uint8List? blob,  String? cngKeyName,  String keyType,  String? pinSecretId)  pubkeyTpm,required TResult Function( String publicOpenssh,  String keystoreAlias,  String keyType)  pubkeyKeystore,required TResult Function()  agent,}) {final _that = this;
switch (_that) {
case BusConnectAuthRef_Password():
...
return pubkeySk(_that.publicOpenssh,_that.credentialId,_that.application,_that.pinSecretId);case BusConnectAuthRef_PubkeySkCert():
return pubkeySkCert(_that.publicOpenssh,_that.credentialId,_that.application,_that.certSecretId,_that.pinSecretId);case BusConnectAuthRef_PubkeyPkcs11():
return pubkeyPkcs11(_that.publicOpenssh,_that.modulePath,_that.tokenSerial,_that.ckaId,_that.keyType,_that.pinSecretId);case BusConnectAuthRef_PubkeyEnclave():
return pubkeyEnclave(_that.publicOpenssh,_that.applicationTag);case BusConnectAuthRef_PubkeyHello():
return pubkeyHello(_that.publicOpenssh,_that.credentialName,_that.keyType);case BusConnectAuthRef_PubkeyTpm():
return pubkeyTpm(_that.publicOpenssh,_that.provider,_that.blob,_that.cngKeyName,_that.keyType,_that.pinSecretId);case BusConnectAuthRef_PubkeyKeystore():
return pubkeyKeystore(_that.publicOpenssh,_that.keystoreAlias,_that.keyType);case BusConnectAuthRef_Agent():
return agent();}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String secretId)?  password,TResult? Function( String keySecretId,  String? passphraseSecretId)?  pubkey,TResult? Function( String keySecretId,  String certSecretId,  String? passphraseSecretId)?  pubkeyCert,TResult? Function( String publicOpenssh,  Uint8List credentialId,  String application,  String? pinSecretId)?  pubkeySk,TResult? Function( String publicOpenssh,  Uint8List credentialId,  String application,  String certSecretId,  String? pinSecretId)?  pubkeySkCert,TResult? Function( String publicOpenssh,  String modulePath,  String tokenSerial,  Uint8List ckaId,  String keyType,  String? pinSecretId)?  pubkeyPkcs11,TResult? Function( String publicOpenssh,  Uint8List applicationTag)?  pubkeyEnclave,TResult? Function( String publicOpenssh,  String credentialName,  String keyType)?  pubkeyHello,TResult? Function( String publicOpenssh,  String provider,  Uint8List? blob,  String? cngKeyName,  String keyType,  String? pinSecretId)?  pubkeyTpm,TResult? Function( String publicOpenssh,  String keystoreAlias,  String keyType)?  pubkeyKeystore,TResult? Function()?  agent,}) {final _that = this;
switch (_that) {
case BusConnectAuthRef_Password() when password != null:
return password(_that.secretId);case BusConnectAuthRef_Pubkey() when pubkey != null:
return pubkey(_that.keySecretId,_that.passphraseSecretId);case BusConnectAuthRef_PubkeyCert() when pubkeyCert != null:
...
class BusConnectAuthRef_PubkeySk extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeySk({required this.publicOpenssh, required this.credentialId, required this.application, this.pinSecretId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeySkCopyWith<BusConnectAuthRef_PubkeySk> get copyWith => _$BusConnectAuthRef_PubkeySkCopyWithImpl<BusConnectAuthRef_PubkeySk>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeySk&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&const DeepCollectionEquality().equals(other.credentialId, credentialId)&&(identical(other.application, application) || other.application == application)&&(identical(other.pinSecretId, pinSecretId) || other.pinSecretId == pinSecretId));
}


@override
int get hashCode => Object.hash(runtimeType,publicOpenssh,const DeepCollectionEquality().hash(credentialId),application,pinSecretId);

@override
String toString() {
  return 'BusConnectAuthRef.pubkeySk(publicOpenssh: $publicOpenssh, credentialId: $credentialId, application: $application, pinSecretId: $pinSecretId)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeySkCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeySkCopyWith(BusConnectAuthRef_PubkeySk value, $Res Function(BusConnectAuthRef_PubkeySk) _then) = _$BusConnectAuthRef_PubkeySkCopyWithImpl;
@useResult
$Res call({
 String publicOpenssh, Uint8List credentialId, String application, String? pinSecretId
});
...
/// @nodoc
class _$BusConnectAuthRef_PubkeySkCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeySkCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeySkCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeySk _self;
  final $Res Function(BusConnectAuthRef_PubkeySk) _then;

/// Create a copy of BusConnectAuthRef
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? credentialId = null,Object? application = null,Object? pinSecretId = freezed,}) {
  return _then(BusConnectAuthRef_PubkeySk(
...
class BusConnectAuthRef_PubkeySkCert extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeySkCert({required this.publicOpenssh, required this.credentialId, required this.application, required this.certSecretId, this.pinSecretId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeySkCertCopyWith<BusConnectAuthRef_PubkeySkCert> get copyWith => _$BusConnectAuthRef_PubkeySkCertCopyWithImpl<BusConnectAuthRef_PubkeySkCert>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeySkCert&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&const DeepCollectionEquality().equals(other.credentialId, credentialId)&&(identical(other.application, application) || other.application == application)&&(identical(other.certSecretId, certSecretId) || other.certSecretId == certSecretId)&&(identical(other.pinSecretId, pinSecretId) || other.pinSecretId == pinSecretId));
}


@override
int get hashCode => Object.hash(runtimeType,publicOpenssh,const DeepCollectionEquality().hash(credentialId),application,certSecretId,pinSecretId);

@override
String toString() {
  return 'BusConnectAuthRef.pubkeySkCert(publicOpenssh: $publicOpenssh, credentialId: $credentialId, application: $application, certSecretId: $certSecretId, pinSecretId: $pinSecretId)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeySkCertCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeySkCertCopyWith(BusConnectAuthRef_PubkeySkCert value, $Res Function(BusConnectAuthRef_PubkeySkCert) _then) = _$BusConnectAuthRef_PubkeySkCertCopyWithImpl;
@useResult
$Res call({
 String publicOpenssh, Uint8List credentialId, String application, String certSecretId, String? pinSecretId
});
...
/// @nodoc
class _$BusConnectAuthRef_PubkeySkCertCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeySkCertCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeySkCertCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeySkCert _self;
  final $Res Function(BusConnectAuthRef_PubkeySkCert) _then;

/// Create a copy of BusConnectAuthRef
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? credentialId = null,Object? application = null,Object? certSecretId = null,Object? pinSecretId = freezed,}) {
  return _then(BusConnectAuthRef_PubkeySkCert(
publicOpenssh: null == publicOpenssh ? _self.publicOpenssh : publicOpenssh // ignore: cast_nullable_to_non_nullable
as String,credentialId: null == credentialId ? _self.credentialId : credentialId // ignore: cast_nullable_to_non_nullable
as Uint8List,application: null == application ? _self.application : application // ignore: cast_nullable_to_non_nullable
as String,certSecretId: null == certSecretId ? _self.certSecretId : certSecretId // ignore: cast_nullable_to_non_nullable
...
class BusConnectAuthRef_PubkeyEnclave extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeyEnclave({required this.publicOpenssh, required this.applicationTag}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeyEnclaveCopyWith<BusConnectAuthRef_PubkeyEnclave> get copyWith => _$BusConnectAuthRef_PubkeyEnclaveCopyWithImpl<BusConnectAuthRef_PubkeyEnclave>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeyEnclave&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&const DeepCollectionEquality().equals(other.applicationTag, applicationTag));
}
...
@override
String toString() {
  return 'BusConnectAuthRef.pubkeyEnclave(publicOpenssh: $publicOpenssh, applicationTag: $applicationTag)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeyEnclaveCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeyEnclaveCopyWith(BusConnectAuthRef_PubkeyEnclave value, $Res Function(BusConnectAuthRef_PubkeyEnclave) _then) = _$BusConnectAuthRef_PubkeyEnclaveCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BusConnectAuthRef_PubkeyEnclaveCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeyEnclaveCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeyEnclaveCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeyEnclave _self;
  final $Res Function(BusConnectAuthRef_PubkeyEnclave) _then;

/// Create a copy of BusConnectAuthRef
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? applicationTag = null,}) {
  return _then(BusConnectAuthRef_PubkeyEnclave(
publicOpenssh: null == publicOpenssh ? _self.publicOpenssh : publicOpenssh // ignore: cast_nullable_to_non_nullable
...
class BusConnectAuthRef_PubkeyHello extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeyHello({required this.publicOpenssh, required this.credentialName, required this.keyType}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeyHelloCopyWith<BusConnectAuthRef_PubkeyHello> get copyWith => _$BusConnectAuthRef_PubkeyHelloCopyWithImpl<BusConnectAuthRef_PubkeyHello>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeyHello&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&(identical(other.credentialName, credentialName) || other.credentialName == credentialName)&&(identical(other.keyType, keyType) || other.keyType == keyType));
}
...
@override
String toString() {
  return 'BusConnectAuthRef.pubkeyHello(publicOpenssh: $publicOpenssh, credentialName: $credentialName, keyType: $keyType)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeyHelloCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeyHelloCopyWith(BusConnectAuthRef_PubkeyHello value, $Res Function(BusConnectAuthRef_PubkeyHello) _then) = _$BusConnectAuthRef_PubkeyHelloCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BusConnectAuthRef_PubkeyHelloCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeyHelloCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeyHelloCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeyHello _self;
  final $Res Function(BusConnectAuthRef_PubkeyHello) _then;

/// Create a copy of BusConnectAuthRef
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? credentialName = null,Object? keyType = null,}) {
  return _then(BusConnectAuthRef_PubkeyHello(
publicOpenssh: null == publicOpenssh ? _self.publicOpenssh : publicOpenssh // ignore: cast_nullable_to_non_nullable
...
class BusConnectAuthRef_PubkeyTpm extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeyTpm({required this.publicOpenssh, required this.provider, this.blob, this.cngKeyName, required this.keyType, this.pinSecretId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeyTpmCopyWith<BusConnectAuthRef_PubkeyTpm> get copyWith => _$BusConnectAuthRef_PubkeyTpmCopyWithImpl<BusConnectAuthRef_PubkeyTpm>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeyTpm&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&(identical(other.provider, provider) || other.provider == provider)&&const DeepCollectionEquality().equals(other.blob, blob)&&(identical(other.cngKeyName, cngKeyName) || other.cngKeyName == cngKeyName)&&(identical(other.keyType, keyType) || other.keyType == keyType)&&(identical(other.pinSecretId, pinSecretId) || other.pinSecretId == pinSecretId));
}
...
@override
String toString() {
  return 'BusConnectAuthRef.pubkeyTpm(publicOpenssh: $publicOpenssh, provider: $provider, blob: $blob, cngKeyName: $cngKeyName, keyType: $keyType, pinSecretId: $pinSecretId)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeyTpmCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeyTpmCopyWith(BusConnectAuthRef_PubkeyTpm value, $Res Function(BusConnectAuthRef_PubkeyTpm) _then) = _$BusConnectAuthRef_PubkeyTpmCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$BusConnectAuthRef_PubkeyTpmCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeyTpmCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeyTpmCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeyTpm _self;
  final $Res Function(BusConnectAuthRef_PubkeyTpm) _then;
...
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? provider = null,Object? blob = freezed,Object? cngKeyName = freezed,Object? keyType = null,Object? pinSecretId = freezed,}) {
  return _then(BusConnectAuthRef_PubkeyTpm(
publicOpenssh: null == publicOpenssh ? _self.publicOpenssh : publicOpenssh // ignore: cast_nullable_to_non_nullable
...
class BusConnectAuthRef_PubkeyKeystore extends BusConnectAuthRef {
  const BusConnectAuthRef_PubkeyKeystore({required this.publicOpenssh, required this.keystoreAlias, required this.keyType}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusConnectAuthRef_PubkeyKeystoreCopyWith<BusConnectAuthRef_PubkeyKeystore> get copyWith => _$BusConnectAuthRef_PubkeyKeystoreCopyWithImpl<BusConnectAuthRef_PubkeyKeystore>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusConnectAuthRef_PubkeyKeystore&&(identical(other.publicOpenssh, publicOpenssh) || other.publicOpenssh == publicOpenssh)&&(identical(other.keystoreAlias, keystoreAlias) || other.keystoreAlias == keystoreAlias)&&(identical(other.keyType, keyType) || other.keyType == keyType));
}


@override
int get hashCode => Object.hash(runtimeType,publicOpenssh,keystoreAlias,keyType);

@override
String toString() {
  return 'BusConnectAuthRef.pubkeyKeystore(publicOpenssh: $publicOpenssh, keystoreAlias: $keystoreAlias, keyType: $keyType)';
}
...
/// @nodoc
abstract mixin class $BusConnectAuthRef_PubkeyKeystoreCopyWith<$Res> implements $BusConnectAuthRefCopyWith<$Res> {
  factory $BusConnectAuthRef_PubkeyKeystoreCopyWith(BusConnectAuthRef_PubkeyKeystore value, $Res Function(BusConnectAuthRef_PubkeyKeystore) _then) = _$BusConnectAuthRef_PubkeyKeystoreCopyWithImpl;
@useResult
$Res call({
 String publicOpenssh, String keystoreAlias, String keyType
});
...
/// @nodoc
class _$BusConnectAuthRef_PubkeyKeystoreCopyWithImpl<$Res>
    implements $BusConnectAuthRef_PubkeyKeystoreCopyWith<$Res> {
  _$BusConnectAuthRef_PubkeyKeystoreCopyWithImpl(this._self, this._then);

  final BusConnectAuthRef_PubkeyKeystore _self;
  final $Res Function(BusConnectAuthRef_PubkeyKeystore) _then;

/// Create a copy of BusConnectAuthRef
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? publicOpenssh = null,Object? keystoreAlias = null,Object? keyType = null,}) {
  return _then(BusConnectAuthRef_PubkeyKeystore(
publicOpenssh: null == publicOpenssh ? _self.publicOpenssh : publicOpenssh // ignore: cast_nullable_to_non_nullable
as String,keystoreAlias: null == keystoreAlias ? _self.keystoreAlias : keystoreAlias // ignore: cast_nullable_to_non_nullable
as String,keyType: null == keyType ? _self.keyType : keyType // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
return recorderRotateRequested(_that);case BusEvent_RecorderWriteFailed() when recorderWriteFailed != null:
return recorderWriteFailed(_that);case BusEvent_TransferTaskAdded() when transferTaskAdded != null:
...
return sessionsChanged(_that);case BusEvent_KeysChanged() when keysChanged != null:
return keysChanged(_that);case BusEvent_ConfigChanged() when configChanged != null:
return configChanged(_that);case BusEvent_TierStateChanged() when tierStateChanged != null:
return tierStateChanged(_that);case BusEvent_UnlockCascadeReady() when unlockCascadeReady != null:
return unlockCascadeReady(_that);case BusEvent_CredentialPromptRequest() when credentialPromptRequest != null:
return credentialPromptRequest(_that);case BusEvent_KeychainProbePromptRequest() when keychainProbePromptRequest != null:
...
return coreLog(_that);case BusEvent_SshAgentSignaturePrompt() when sshAgentSignaturePrompt != null:
return sshAgentSignaturePrompt(_that);case _:
  return orElse();
...
return recorderRotateRequested(_that);case BusEvent_RecorderWriteFailed():
return recorderWriteFailed(_that);case BusEvent_TransferTaskAdded():
...
return sessionsChanged(_that);case BusEvent_KeysChanged():
return keysChanged(_that);case BusEvent_ConfigChanged():
return configChanged(_that);case BusEvent_TierStateChanged():
return tierStateChanged(_that);case BusEvent_UnlockCascadeReady():
return unlockCascadeReady(_that);case BusEvent_CredentialPromptRequest():
return credentialPromptRequest(_that);case BusEvent_KeychainProbePromptRequest():
...
return coreLog(_that);case BusEvent_SshAgentSignaturePrompt():
return sshAgentSignaturePrompt(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
/// It is equivalent to doing:
...
return recorderRotateRequested(_that.id,_that.bytesWritten);case BusEvent_RecorderWriteFailed() when recorderWriteFailed != null:
return recorderWriteFailed(_that.id,_that.kind,_that.detail);case BusEvent_TransferTaskAdded() when transferTaskAdded != null:
...
return sessionsChanged();case BusEvent_KeysChanged() when keysChanged != null:
return keysChanged();case BusEvent_ConfigChanged() when configChanged != null:
return configChanged(_that.json);case BusEvent_TierStateChanged() when tierStateChanged != null:
return tierStateChanged(_that.stateWireName);case BusEvent_UnlockCascadeReady() when unlockCascadeReady != null:
return unlockCascadeReady(_that.tierWire,_that.hasKey);case BusEvent_CredentialPromptRequest() when credentialPromptRequest != null:
return credentialPromptRequest(_that.promptId,_that.sessionId,_that.kindWireName);case BusEvent_KeychainProbePromptRequest() when keychainProbePromptRequest != null:
...
return coreLog(_that.levelWireName,_that.name,_that.message);case BusEvent_SshAgentSignaturePrompt() when sshAgentSignaturePrompt != null:
return sshAgentSignaturePrompt(_that.requestId,_that.keyId,_that.keyLabel,_that.requester);case _:
  return orElse();
...
return recorderRotateRequested(_that.id,_that.bytesWritten);case BusEvent_RecorderWriteFailed():
return recorderWriteFailed(_that.id,_that.kind,_that.detail);case BusEvent_TransferTaskAdded():
...
return sessionsChanged();case BusEvent_KeysChanged():
return keysChanged();case BusEvent_ConfigChanged():
return configChanged(_that.json);case BusEvent_TierStateChanged():
return tierStateChanged(_that.stateWireName);case BusEvent_UnlockCascadeReady():
return unlockCascadeReady(_that.tierWire,_that.hasKey);case BusEvent_CredentialPromptRequest():
return credentialPromptRequest(_that.promptId,_that.sessionId,_that.kindWireName);case BusEvent_KeychainProbePromptRequest():
...
return coreLog(_that.levelWireName,_that.name,_that.message);case BusEvent_SshAgentSignaturePrompt():
return sshAgentSignaturePrompt(_that.requestId,_that.keyId,_that.keyLabel,_that.requester);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class BusEvent_RecorderWriteFailed extends BusEvent {
  const BusEvent_RecorderWriteFailed({required this.id, required this.kind, required this.detail}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusEvent_RecorderWriteFailedCopyWith<BusEvent_RecorderWriteFailed> get copyWith => _$BusEvent_RecorderWriteFailedCopyWithImpl<BusEvent_RecorderWriteFailed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_RecorderWriteFailed&&(identical(other.id, id) || other.id == id)&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.detail, detail) || other.detail == detail));
}


@override
int get hashCode => Object.hash(runtimeType,id,kind,detail);

@override
String toString() {
  return 'BusEvent.recorderWriteFailed(id: $id, kind: $kind, detail: $detail)';
}
...
/// @nodoc
abstract mixin class $BusEvent_RecorderWriteFailedCopyWith<$Res> implements $BusEventCopyWith<$Res> {
  factory $BusEvent_RecorderWriteFailedCopyWith(BusEvent_RecorderWriteFailed value, $Res Function(BusEvent_RecorderWriteFailed) _then) = _$BusEvent_RecorderWriteFailedCopyWithImpl;
@useResult
$Res call({
 String id, String kind, String detail
});
...
/// @nodoc
class _$BusEvent_RecorderWriteFailedCopyWithImpl<$Res>
    implements $BusEvent_RecorderWriteFailedCopyWith<$Res> {
  _$BusEvent_RecorderWriteFailedCopyWithImpl(this._self, this._then);

  final BusEvent_RecorderWriteFailed _self;
  final $Res Function(BusEvent_RecorderWriteFailed) _then;

/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? id = null,Object? kind = null,Object? detail = null,}) {
  return _then(BusEvent_RecorderWriteFailed(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
class BusEvent_KeysChanged extends BusEvent {
  const BusEvent_KeysChanged(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_KeysChanged);
}
...
class BusEvent_UnlockCascadeReady extends BusEvent {
  const BusEvent_UnlockCascadeReady({required this.tierWire, required this.hasKey}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusEvent_UnlockCascadeReadyCopyWith<BusEvent_UnlockCascadeReady> get copyWith => _$BusEvent_UnlockCascadeReadyCopyWithImpl<BusEvent_UnlockCascadeReady>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_UnlockCascadeReady&&(identical(other.tierWire, tierWire) || other.tierWire == tierWire)&&(identical(other.hasKey, hasKey) || other.hasKey == hasKey));
}


@override
int get hashCode => Object.hash(runtimeType,tierWire,hasKey);

@override
String toString() {
  return 'BusEvent.unlockCascadeReady(tierWire: $tierWire, hasKey: $hasKey)';
}
...
/// @nodoc
abstract mixin class $BusEvent_UnlockCascadeReadyCopyWith<$Res> implements $BusEventCopyWith<$Res> {
  factory $BusEvent_UnlockCascadeReadyCopyWith(BusEvent_UnlockCascadeReady value, $Res Function(BusEvent_UnlockCascadeReady) _then) = _$BusEvent_UnlockCascadeReadyCopyWithImpl;
@useResult
$Res call({
 String tierWire, bool hasKey
});
...
/// @nodoc
class _$BusEvent_UnlockCascadeReadyCopyWithImpl<$Res>
    implements $BusEvent_UnlockCascadeReadyCopyWith<$Res> {
  _$BusEvent_UnlockCascadeReadyCopyWithImpl(this._self, this._then);

  final BusEvent_UnlockCascadeReady _self;
  final $Res Function(BusEvent_UnlockCascadeReady) _then;

/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? tierWire = null,Object? hasKey = null,}) {
  return _then(BusEvent_UnlockCascadeReady(
tierWire: null == tierWire ? _self.tierWire : tierWire // ignore: cast_nullable_to_non_nullable
...
class BusEvent_HardwareVaultSealPromptRequest extends BusEvent {
  const BusEvent_HardwareVaultSealPromptRequest({required this.promptId, required this.dbKeySecretId, this.pinSecretId}): super._();
  

 final  String promptId;
 final  String dbKeySecretId;
 final  String? pinSecretId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusEvent_HardwareVaultSealPromptRequestCopyWith<BusEvent_HardwareVaultSealPromptRequest> get copyWith => _$BusEvent_HardwareVaultSealPromptRequestCopyWithImpl<BusEvent_HardwareVaultSealPromptRequest>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_HardwareVaultSealPromptRequest&&(identical(other.promptId, promptId) || other.promptId == promptId)&&(identical(other.dbKeySecretId, dbKeySecretId) || other.dbKeySecretId == dbKeySecretId)&&(identical(other.pinSecretId, pinSecretId) || other.pinSecretId == pinSecretId));
}


@override
int get hashCode => Object.hash(runtimeType,promptId,dbKeySecretId,pinSecretId);

@override
String toString() {
  return 'BusEvent.hardwareVaultSealPromptRequest(promptId: $promptId, dbKeySecretId: $dbKeySecretId, pinSecretId: $pinSecretId)';
}
...
/// @nodoc
abstract mixin class $BusEvent_HardwareVaultSealPromptRequestCopyWith<$Res> implements $BusEventCopyWith<$Res> {
  factory $BusEvent_HardwareVaultSealPromptRequestCopyWith(BusEvent_HardwareVaultSealPromptRequest value, $Res Function(BusEvent_HardwareVaultSealPromptRequest) _then) = _$BusEvent_HardwareVaultSealPromptRequestCopyWithImpl;
@useResult
$Res call({
 String promptId, String dbKeySecretId, String? pinSecretId
});
...
/// @nodoc
class _$BusEvent_HardwareVaultSealPromptRequestCopyWithImpl<$Res>
    implements $BusEvent_HardwareVaultSealPromptRequestCopyWith<$Res> {
  _$BusEvent_HardwareVaultSealPromptRequestCopyWithImpl(this._self, this._then);

  final BusEvent_HardwareVaultSealPromptRequest _self;
  final $Res Function(BusEvent_HardwareVaultSealPromptRequest) _then;

/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? promptId = null,Object? dbKeySecretId = null,Object? pinSecretId = freezed,}) {
  return _then(BusEvent_HardwareVaultSealPromptRequest(
promptId: null == promptId ? _self.promptId : promptId // ignore: cast_nullable_to_non_nullable
as String,dbKeySecretId: null == dbKeySecretId ? _self.dbKeySecretId : dbKeySecretId // ignore: cast_nullable_to_non_nullable
as String,pinSecretId: freezed == pinSecretId ? _self.pinSecretId : pinSecretId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class BusEvent_CoreLog extends BusEvent {
  const BusEvent_CoreLog({required this.levelWireName, required this.name, required this.message}): super._();
  

 final  String levelWireName;
 final  String name;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusEvent_CoreLogCopyWith<BusEvent_CoreLog> get copyWith => _$BusEvent_CoreLogCopyWithImpl<BusEvent_CoreLog>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_CoreLog&&(identical(other.levelWireName, levelWireName) || other.levelWireName == levelWireName)&&(identical(other.name, name) || other.name == name)&&(identical(other.message, message) || other.message == message));
}


@override
int get hashCode => Object.hash(runtimeType,levelWireName,name,message);

@override
String toString() {
  return 'BusEvent.coreLog(levelWireName: $levelWireName, name: $name, message: $message)';
}
...
/// @nodoc
abstract mixin class $BusEvent_CoreLogCopyWith<$Res> implements $BusEventCopyWith<$Res> {
  factory $BusEvent_CoreLogCopyWith(BusEvent_CoreLog value, $Res Function(BusEvent_CoreLog) _then) = _$BusEvent_CoreLogCopyWithImpl;
@useResult
$Res call({
 String levelWireName, String name, String message
});
...
/// @nodoc
class _$BusEvent_CoreLogCopyWithImpl<$Res>
    implements $BusEvent_CoreLogCopyWith<$Res> {
  _$BusEvent_CoreLogCopyWithImpl(this._self, this._then);

  final BusEvent_CoreLog _self;
  final $Res Function(BusEvent_CoreLog) _then;

/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? levelWireName = null,Object? name = null,Object? message = null,}) {
  return _then(BusEvent_CoreLog(
levelWireName: null == levelWireName ? _self.levelWireName : levelWireName // ignore: cast_nullable_to_non_nullable
...
class BusEvent_SshAgentSignaturePrompt extends BusEvent {
  const BusEvent_SshAgentSignaturePrompt({required this.requestId, required this.keyId, required this.keyLabel, this.requester}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusEvent_SshAgentSignaturePromptCopyWith<BusEvent_SshAgentSignaturePrompt> get copyWith => _$BusEvent_SshAgentSignaturePromptCopyWithImpl<BusEvent_SshAgentSignaturePrompt>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_SshAgentSignaturePrompt&&(identical(other.requestId, requestId) || other.requestId == requestId)&&(identical(other.keyId, keyId) || other.keyId == keyId)&&(identical(other.keyLabel, keyLabel) || other.keyLabel == keyLabel)&&(identical(other.requester, requester) || other.requester == requester));
}


@override
int get hashCode => Object.hash(runtimeType,requestId,keyId,keyLabel,requester);

@override
String toString() {
  return 'BusEvent.sshAgentSignaturePrompt(requestId: $requestId, keyId: $keyId, keyLabel: $keyLabel, requester: $requester)';
}
...
/// @nodoc
abstract mixin class $BusEvent_SshAgentSignaturePromptCopyWith<$Res> implements $BusEventCopyWith<$Res> {
  factory $BusEvent_SshAgentSignaturePromptCopyWith(BusEvent_SshAgentSignaturePrompt value, $Res Function(BusEvent_SshAgentSignaturePrompt) _then) = _$BusEvent_SshAgentSignaturePromptCopyWithImpl;
@useResult
$Res call({
 String requestId, String keyId, String keyLabel, String? requester
});
...
/// @nodoc
class _$BusEvent_SshAgentSignaturePromptCopyWithImpl<$Res>
    implements $BusEvent_SshAgentSignaturePromptCopyWith<$Res> {
  _$BusEvent_SshAgentSignaturePromptCopyWithImpl(this._self, this._then);

  final BusEvent_SshAgentSignaturePrompt _self;
  final $Res Function(BusEvent_SshAgentSignaturePrompt) _then;

/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? requestId = null,Object? keyId = null,Object? keyLabel = null,Object? requester = freezed,}) {
  return _then(BusEvent_SshAgentSignaturePrompt(
