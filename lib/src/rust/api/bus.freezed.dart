...
return hardwareVaultSealPromptRequest(_that);case BusEvent_KeychainOpPromptRequest() when keychainOpPromptRequest != null:
...
return hardwareVaultSealPromptRequest(_that);case BusEvent_KeychainOpPromptRequest():
...
return hardwareVaultSealPromptRequest(_that.promptId,_that.dbKey,_that.pin);case BusEvent_KeychainOpPromptRequest() when keychainOpPromptRequest != null:
...
return hardwareVaultSealPromptRequest(_that.promptId,_that.dbKey,_that.pin);case BusEvent_KeychainOpPromptRequest():
...
class BusEvent_HardwareVaultSealPromptRequest extends BusEvent {
  const BusEvent_HardwareVaultSealPromptRequest({required this.promptId, required this.dbKey, this.pin}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BusEvent_HardwareVaultSealPromptRequest&&(identical(other.promptId, promptId) || other.promptId == promptId)&&const DeepCollectionEquality().equals(other.dbKey, dbKey)&&(identical(other.pin, pin) || other.pin == pin));
}


@override
int get hashCode => Object.hash(runtimeType,promptId,const DeepCollectionEquality().hash(dbKey),pin);

@override
String toString() {
  return 'BusEvent.hardwareVaultSealPromptRequest(promptId: $promptId, dbKey: $dbKey, pin: $pin)';
}
...
@useResult
$Res call({
 String promptId, Uint8List dbKey, String? pin
});
...
/// Create a copy of BusEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? promptId = null,Object? dbKey = null,Object? pin = freezed,}) {
...
as Uint8List,pin: freezed == pin ? _self.pin : pin // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
