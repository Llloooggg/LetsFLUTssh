...
return coreLog(_that.levelWireName,_that.name,_that.message);case _:
  return orElse();
...
return coreLog(_that.levelWireName,_that.name,_that.message);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
