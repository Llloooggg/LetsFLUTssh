...
**Follow AGENTS.md "Testing Methodology"** — it covers the three hard-to-remember invariants:
...
When in doubt re-read those sections in AGENTS.md verbatim; they are not paraphrased here on purpose.
