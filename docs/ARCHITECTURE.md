...
**Module layout.** Both halves of the pipeline (cert / keychain / codesign + DMG installer) live Rust-side in [`rust/crates/lfs_os_security/src/macos/`](../rust/crates/lfs_os_security/src/macos/); Dart only carries the FRB-shim adapter ([`lib/platform/macos/code_signing_client.dart`](../lib/platform/macos/code_signing_client.dart)) and the FRB call from [`update_provider.dart`](../lib/providers/update_provider.dart) into the installer.
